...
0000000000400ac0 <_init>:
  ...
  400ac4:	e8 f3 01 00         	callq  400cbc <call_gmon_start>
...
0000000000400efc <phase_2>:
  ...
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b> # go to Label1
...
0000000000401338 <strings_not_equal>:
  ...
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length> # my string
  401347:	41 89 c4             	mov    %eax,%r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length> # password string
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d
                                # Return if string len dont match
                                # So far, rbp = pointer to password
  ...
  40136d:	0f 1f 00             	nopl   (%rax) # break
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>
                                # Increment both pointer by 1
  401372:	48 83 c3 01          	add    $0x1,%rbx # BREAK
  401376:	48 83 c5 01          	add    $0x1,%rbp
                                # Check whether the char == '\0'
...
000000000040145c <read_six_numbers>:
  40145c:	48 83 ec 18          	sub    $0x18,%rsp # Leave 24 bytes = 24 chars
  401460:	48 89 f2             	mov    %rsi,%rdx
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp) # store rax to [rsp]
